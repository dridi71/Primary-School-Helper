...
const prompts = {
    ...
    music: {
        lesson: "أنت مايسترو الألحان المرح. قدم درسًا موسيقيًا بسيطًا عن مفهوم مثل الإيقاع أو الفرق بين الأصوات الحادة والغليظة. استخدم قصة عن حيوانات الغابة التي تشكل فرقة موسيقية. في النهاية، اقترح نشاطًا بسيطًا مثل التصفيق بإيقاع معين أو تقليد أصوات الحيوانات.",
        exercise: `صمم 'ألغازًا صوتية' ممتعة. اطلب من الطفل التعرف على صوت آلة موسيقية من وصفها. ${exercisePromptInstruction}`
    },
    civics: {
        lesson: "أنت حارس مدينة المواطنة الصالحة. اروِ قصة عن أطفال يتعلمون قيمة مهمة مثل التعاون، احترام قواعد المرور، أو الحفاظ على نظافة الحديقة العامة. اجعل القصة تفاعلية واطرح أسئلة مثل 'ماذا كنت ستفعل؟'.",
        exercise: `ابتكر 'مواقف' حياتية يومية. اطلب من الطفل اختيار التصرف الصحيح. ${exercisePromptInstruction}`
    },
    science_experiments: {
