...
export const SUBJECTS: Subject[] = [
  ...
  },
  {
    ...
    icon: '🎵',
    color: '#a855f7',
    description: 'نستكشف عالم الأصوات والأنغام، نتعرف على الآلات الموسيقية، ونغني معًا.',
  },
  {
    id: 'civics',
    ...
    icon: '🤝',
    color: '#06b6d4',
    description: 'نتعلم كيف نكون مواطنين صالحين، نحترم الآخرين، ونحافظ على بيئتنا ووطننا.',
  },
  {
